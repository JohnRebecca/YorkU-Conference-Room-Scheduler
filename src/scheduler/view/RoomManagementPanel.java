...
public class RoomManagementPanel extends JPanel {
    ...
    private JPanel createRoomForm() {
        ...
        JButton addButton = actionButton("Add Room", Theme.RED);
        JButton enableButton = actionButton("Enable", Theme.SIDEBAR_HOVER);
        JButton disableButton = actionButton("Disable", Theme.SIDEBAR_HOVER);
        JButton closeButton = actionButton("Close", Theme.SIDEBAR_HOVER);
