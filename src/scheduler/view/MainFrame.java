...
public class MainFrame extends JFrame {
    ...
    private void setupLayout() {
        ...
        // MyBookingsPanel gets paymentService so it can pass to BookingCardPanel
        myBookingsPanel = new MyBookingsPanel(bookingService, checkInService, userContext, paymentService);
        ...
        // Simple placeholder for the Payment sidebar button
        // Users will actually pay from "My Bookings" → "Pay Now" on each booking card
        PlaceholderPanel paymentPanel = new PlaceholderPanel(
                "Payment",
                "Go to 'My Bookings' and click 'Pay Now' on a booking to make a payment.\n"
                + "You can pay with Credit Card, Debit Card, or Institutional Billing."
        );

        PlaceholderPanel profilePanel = new PlaceholderPanel(
                "Profile",
                "Account creation, password rules, and university verification are handled by the account & authentication module."
        );

        PlaceholderPanel checkInPanel = new PlaceholderPanel(
                "Check In",
                "Check in from the 'Check In' button on a confirmed booking under My Bookings."
        );
