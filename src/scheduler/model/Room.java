...
public class Room {
    ...
    public Room(String roomId, int capacity, String building, String location, double hourlyRate) {
        this.roomId = roomId;
        this.capacity = capacity;
        this.building = building;
        this.location = location;
        this.enabled = true;
        this.closedForMaintenance = false;
        this.hourlyRate = hourlyRate;  // ← ADDED
    }
    ...
    public double getHourlyRate() {  // ← ADDED
        return hourlyRate;
    }
